...
- **Plattform:** Android (minSdk 26, targetSdk 35, compileSdk 36). Eine iOS-App ist als Gerüst angelegt, siehe [`iosApp/README.md`](iosApp/README.md).
...
|---|---|
| **Home** | Training starten (Plan, Meta-Plan oder frei), Wochenvolumen, Muskel-Heatmap, Hinweis auf offene Progressionsvorschläge |
| **Aktives Workout** | Sätze loggen (Gewicht, Wiederholungen, Aufwärmsatz, RPE/RIR), Pausen-Timer, Supersätze, Hinweise aus dem letzten Training, Live-Erkennung von Rekorden |
| **Pläne** | Trainingspläne mit Zielwerten pro Übung, Meta-Pläne (Rotation über Teilpläne, inkl. „Überspringen“), Progressionsschema pro Planübung |
...
| **Verlauf** | Alle Trainings (Paging), Detailansicht, Löschen per Wischgeste |
| **Übungen** | Übungsbibliothek, eigene Übungen, Archivieren, Statistik pro Übung (Rekorde, geschätztes 1RM, Verlaufsdiagramm) |
| **Einstellungen** | Einheiten (kg/lb), Wochenstart, Design (3 Farbschemata, Hell/Dunkel/System, Dynamic Color), reduzierte Animationen, RPE/RIR/Aus, Trainings-Erinnerungen, Backup-Export/-Import, internes Sicherheitsbackup, Incident-Report |
...
Emulator-Tests (`connectedDebugAndroidTest`) laufen in der GitHub-CI.
